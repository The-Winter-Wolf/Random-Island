...
bool cIntersections::m_TestAABB_AABB(glm::vec3& posA, glm::vec3& posB, glm::vec3& halfSizeA, glm::vec3& halfSizeB)
{
...
bool cIntersections::m_TestSphereTriangle(float& sphereRadius, glm::vec3& vert0, glm::vec3& vert1, glm::vec3& vert2,
...
// Chapter 5:
glm::vec3 cIntersections::m_ClosestPtPointTriangle(glm::vec3 p, glm::vec3 a, glm::vec3 b, glm::vec3 c)
{
	glm::vec3 ab = b - a;
	glm::vec3 ac = c - a;
	glm::vec3 bc = c - b;
